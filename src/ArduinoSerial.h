...
class ArduinoSerial
{
 public:
     ...
     *
     * @returns True if handshake successful, false if unsuccessful.
     *
     * @throws std::runtime_error If opening or configuring the port fails, throw an error.
     */
    bool openPort(SerialPort port, int baudRate);
